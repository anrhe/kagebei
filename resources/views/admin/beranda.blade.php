                ...
                <div class="p-6 text-gray-900">
                    <div class="space-y-6">
                        ...
                        @if (Auth::user()->role == 'user')
                            <!-- Card 1 -->
                            <div class="bg-blue-500 text-white rounded-lg shadow-lg p-6 transition duration-200 hover:shadow-xl">
                                <h3 class="text-lg font-semibold mb-4">Lihat Jemaat Gereja</h3>
                        ...
                        @if (Auth::user()->role == 'operator' || Auth::user()->role == 'gembala')
                            <!-- Card 1 -->
                            <div class="bg-blue-500 text-white rounded-lg shadow-lg p-6 transition duration-200 hover:shadow-xl">
                                <h3 class="text-lg font-semibold mb-4">Kelola Jemaat Gereja</h3>
                        ...
                        @if (Auth::user()->role == 'operator')
                            <!-- Card 2 -->
                            <div class="bg-blue-500 text-white rounded-lg shadow-lg p-6 transition duration-200 hover:shadow-xl">
                                <h3 class="text-lg font-semibold mb-4">Kelola Keuangan</h3>
